...
const f_s_model = require('./../model/false_link');
    ...
    auth.check(req)
        .then(async (r) => {
            ...
            let a = new f_s_model({
                ...
                res.render('admin/fast_link/add.ejs', {d: true,pr:as.perm})
            })
        })
        .catch(() => {
    ...
    auth.check(req)
        .then(async (r) => {
            ...
            f_s_model.findOneAndUpdate({_id: req.params.id}, body, async (e, data) => {
                ...
                res.render('admin/fast_link/edit.ejs', {d, s: true,pr:as.perm});
            })
        })
        .catch(() => {
            res.redirect('/admin/login')
...
app.get('/add', (req, res) => {
    auth.check(req)
        .then(async (r) => {
            let as=await users_model.findOne({username:r.username}).exec();
            res.render('admin/fast_link/add.ejs', {d: false,pr:as.perm})
        })
        .catch(() => {
            res.redirect('/admin/login')
        })
    ...
    auth.check(req)
        .then(async (r) => {
            ...
            f_s_model.findOne({_id: req.params.id}, (e, d) => {
                res.render('admin/fast_link/edit.ejs', {d, s: null,pr:as.perm});
            })
        })
        .catch(() => {
            res.redirect('/admin/login')
    ...
    auth.check(req)
        .then(async (r) => {
            ...
            f_s_model.find({}, (e, data) => {
                ...
                console.log(data);
                res.render('admin/fast_link/index.ejs', {data: a,pr:as.perm})
            })
        })
        .catch(() => {
            res.redirect('/admin/login')
